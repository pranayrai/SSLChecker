...
public class ApplicationRunner {
    ...
    public static void main(String[] args) throws IOException {
        ...
        {
            System.out.println(httpsUrls.get(y).substring(httpsUrls.get(y).indexOf(":")+3));
            ...
            URLInfo urlInfo = new URLInfo(httpsUrls.get(y).substring(httpsUrls.get(y).indexOf(":")+3), "Live", "Yes", validity, phistank, expiryD, expires, protocols, CS);
        ...
        {
            System.out.println(httpUrls.get(z).substring(httpUrls.get(z).indexOf(":")+3));
            ...
            URLInfo urlInfo = new URLInfo(httpUrls.get(z).substring(httpUrls.get(z).indexOf(":")+3),"Live", "No", "NA", phistank, "NA", null, null, null  );
            URLObjects.add(urlInfo);
            System.out.println(httpUrls.get(z).substring(httpUrls.get(z).indexOf(":")+3));
        }
        ...
        {
            URLInfo urlInfo = new URLInfo(invalidUrls.get(x), "Invalid URL", "NA", "NA", "NA", "NA", null, null, null);
            URLObjects.add(urlInfo);
        }
        ...
        sb.append("name, Site status, HTTPS?, cert date valid?, trustworthy?, expiry date, cert expires in(days), supported protocols, enabled cipher suites\n");
        ...
        sb1.append("name, Site status, HTTPS?, cert date valid?, trustworthy?, expiry date, cert expires in(days), supported protocols, enabled cipher suites\n");
